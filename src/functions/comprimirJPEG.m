function [myFinalEncodedImage] = comprimirJPEG(fotoAUsar, imgPath, quality, comprTimes)

%Esta funcion solamente hace la compresion JPEG de la fotoAUsar codifTimes veces, sin guardar
%info en ningun lado.
%Se devuelve la imagen en myFinalEncodedImage y en imgPath
 ...
 % usar la tabla según la calidad requerida
   ...
   if agregoOffset
    ...
    %------------------
    %HAGO LA COMPRESION COMPRTIMES VECES
    %------------------
    for counter=0:comprTimes
        ...
        for myColorComponent = 1:oImgComponents
            ...
            for i=0:dctRowBlocks-1
               for j=0:dctColBlocks-1
                ...
                %Aqui se haria la codificacion pero esta funcion NO CODIFICA
        ...
        %------------------------------------INVERSE--------------------------------%
        %------------------------------De nuevo a mapa RGB--------------------------%
         %Agrepar coefs en 8x8. Multiplicar por tabla de cuantización. Invertir DCT, volver a RGB
    ...
    end    %fin de la iteración de veces de compresión
